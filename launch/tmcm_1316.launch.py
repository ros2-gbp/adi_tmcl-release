...
def generate_launch_description():
  ...
  ## Include YAML file
  autogenerated_yaml = os.path.join(tmcl_ros2_pkg_dir, 'config', 'autogenerated', 'TMCM-1316.yaml')
  ext_yaml = os.path.join(tmcl_ros2_pkg_dir, 'config', 'TMCM-1316_Ext.yaml')
  ...
  arg_tmcl_base_name = DeclareLaunchArgument('tmcl_base_name', default_value='tmcm1316')
