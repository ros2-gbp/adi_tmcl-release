...
def generate_launch_description():
  ...
  ## Include YAML file
  autogenerated_yaml = os.path.join(tmcl_ros2_pkg_dir, 'config', 'autogenerated', 'TMCM-2611.yaml')
  ext_yaml = os.path.join(tmcl_ros2_pkg_dir, 'config', 'TMCM-2611_Ext.yaml')
  ...
  arg_tmcl_base_name = DeclareLaunchArgument('tmcl_base_name', default_value='tmcm2611')
  ...
  arg_mtr0_pos_x = DeclareLaunchArgument('mtr0_pos_x', default_value='-.50')
  ...
  arg_mtr1_pos_x = DeclareLaunchArgument('mtr1_pos_x', default_value='.50')
